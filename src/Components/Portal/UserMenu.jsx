...
const UserMenu = () => {
  ...
  return (
    <div>
      <div
        className="fixed z-20 bottom-20 sm:bottom-9 left-5 bg-white hover:bg-black hover:text-white active:bg-black active:text-white w-[50px] h-[50px] leading-[50px] text-center rounded-full shadow-box"
      ...
      {acountMenu.map((list, index) => (
        <div
          ...
          className={`fixed z-10 shadow-box  ${
            route === list.path
              ? "bg-black text-white"
