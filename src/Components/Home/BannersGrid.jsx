...
const BannersGrid = () => {
  const BannarContent = ({ imgSrc, heading, text }) => {
    return (
      <div className="relative row-span-1 group overflow-hidden rounded-2xl">
        <div className="flex flex-col gap-4 uppercase absolute z-10 top-1/2 left-10 -translate-y-1/2 justify-center items-start w-[max-content]">
          ...
          <button className="rounded-2xl text-[11px] uppercase outline-none cursor-pointer text-white hover:text-red-500 transition-colors mt-6 group">
            read more
            <FontAwesomeIcon
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 grid-rows-6 sm:grid-rows-4 lg:grid-rows-2 gap-4 max-h-[1800px] sm:max-h-[1200px] lg:max-h-[800px]">
      <BannersGrid_Slider />
      <div className="relative col-span-1 row-span-2 group overflow-hidden rounded-2xl">
        ...
        <div className="flex flex-col gap-3 uppercase absolute top-10 left-1/2 -translate-x-1/2 justify-center items-center w-[max-content]">
          ...
          <button className="bg-white py-3 px-7 rounded-2xl text-[11px] uppercase outline-none cursor-pointer hover:bg-red-500 hover:text-white transition-colors">
            shop now
          </button>
        </div>
      </div>
